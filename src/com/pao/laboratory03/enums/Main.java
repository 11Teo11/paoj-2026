...
public class Main {
    public static void main(String[] args) {
        ...
        for (Priority p : Priority.values())
            System.out.println(p.getEmoji() + " " + p.name() + " (level = " + p.ordinal() + ", " + p.getColor() + ")");

        System.out.println("\n=== Switch pe prioritate ===");
        Priority current = Priority.HIGH;
        switch (current)
        {
            case LOW: System.out.println("E ok! Prioritate scazuta"); break;
            case MEDIUM: System.out.println("Merge... Prioritate moderata"); break;
            case HIGH: System.out.println("Atenție! Prioritate ridicată!"); break;
            case CRITICAL: System.out.println("Aoleu e jale!"); break;
        }
